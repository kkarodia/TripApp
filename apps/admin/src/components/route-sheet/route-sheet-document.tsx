...
import type { Trip, RoadType } from '@routedesk/types'
    ...
    >
        ...
        <tbody>
          ...
          {trip.stops.map((stop) => (
            ...
            >
              ...
              <td className="py-[8px] px-[6px]">
                <span className="text-[12px] text-[#111] block">{stop.address}</span>
                {stop.geocodeFailed && (
      ...
      <div className="grid grid-cols-3 border-t border-[#111] border-b border-b-[#ddd] mb-[20px]">
        {[
          ...
          <div key={label} className={cn('py-[10px] px-[8px]', i > 0 && 'border-l border-[#ddd]')}>
