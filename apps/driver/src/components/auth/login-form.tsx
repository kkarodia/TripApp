...
export function LoginForm() {
  ...
  return (
    <div className="min-h-dvh surface-pattern-ground flex items-center justify-center px-4">
      <div className="w-full max-w-[380px]">
        ...
        <div className="surface-pattern-panel rounded-[--radius-lg] border border-[--color-border-subtle] p-7">
          ...
          <p className="text-[13px] text-[--color-text-tertiary] mb-6">
            Driver accounts only. Managers use the dispatch portal.
          </p>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center px-4 py-2.5 rounded-[--radius-md] bg-[--color-brand] text-white text-[13px] font-semibold hover:bg-[--color-brand-hover] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
        ...
        <p className="text-center text-[12px] text-[--color-info] mt-5">
          Forgot your password? Contact dispatch.
        </p>
      </div>
    </div>
  )
